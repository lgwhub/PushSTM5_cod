...
typedef enum
{
  TIM2_FORCEDACTION_ACTIVE           = ((uint8_t)0x50),			//HIGH
  TIM2_FORCEDACTION_INACTIVE         = ((uint8_t)0x40)			//LOW
...
typedef enum
{
 ...
 // TIM2_OCMODE_FORCE_LOW       = ((uint8_t)0x40),	//20140114
 // TIM2_OCMODE_FORCE_HIGH       = ((uint8_t)0x50), //20140114 
